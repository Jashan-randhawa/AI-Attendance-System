...
@router.get("/daily", response_model=List[DailyAttendanceStat], dependencies=[Depends(require_admin)])
...
@router.get("/persons", response_model=List[PersonAttendanceStat], dependencies=[Depends(require_admin)])
...
@router.get("/heatmap", dependencies=[Depends(require_admin)])
async def heatmap(
