...
@router.get("/metrics", response_model=DashboardMetrics, dependencies=[Depends(require_operator)])
...
@router.get("/activity", response_model=list[ActivityItem], dependencies=[Depends(require_operator)])
